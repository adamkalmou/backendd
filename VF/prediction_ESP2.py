...
model = joblib.load('C:/Users/ADAM/Desktop/Nouveau dossier (9)/projet pfe vf/VF/species_prediction_model_ESP2.pkl')
...
for _, grid_row in grid_shapefile.iterrows():
    ...
    if points_in_square.empty:
        ...
        pres_esp1_values = points_in_square['Pres_Esp2_pred']
...
ax.set_title("Grid Square Coloring Based on Predicted Species Presence (Pres_Esp2)", fontsize=16)
